...
public final class FileUtil {
    ...
    public static void uploadFileSpringMVC(CommonsMultipartFile cmFile, String targetPathNameWithoutSuffix) throws Exception {
        if (!cmFile.isEmpty()) {
            File file = new File(targetPathNameWithoutSuffix + "." + getSuffix(cmFile.getOriginalFilename()));
            createParentDirectorys(targetPathNameWithoutSuffix + "." + getSuffix(cmFile.getName()));
