                ...
                , href: function (editor) { //超链接
                    layer.prompt({
                        ...
                        if (!/^http(s*):\/\/[\S]/.test(val)) {
                            layer.tips('这根本不是个链接，不要骗我。', elem, {tips: 1, time: 1000})
                            return;
                        }
