	...
	<div class="layui-body site-demo">
		<div class="layui-main">
			...
			<div class="layui-elem-quote" style="margin-top: 10px;">
					<span class="layui-breadcrumb"> <a><cite>内容管理</cite></a> <a><cite>修改标签</cite></a>
					</span>
			</div>
			<blockquote class="layui-elem-quote layui-quote-nm" style="color: #FF5722">
				<i class="layui-icon">&#xe60b;</i> 啦啦啦，修改标签。
			</blockquote>
			<!--/*******操作*******/-->
			<form action="edit" method="post" class="layui-form">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input value="${result.code}" maxlength="45" type="text" name="code" lay-verify="required" autocomplete="off"
