	...
	<div class="layui-body site-demo">
		<div class="layui-main">
			...
			<blockquote class="layui-elem-quote layui-quote-nm" style="color: #FF5722">
				<i class="layui-icon">&#xe60b;</i> 啦啦啦，修改常用工具。
			</blockquote>
			<!--/*******操作*******/-->
			<form action="edit" method="post" class="layui-form">
				<input value="${result.id}" name="id" type="text" hidden="hidden" />
				<fieldset class="layui-elem-field layui-field-title">
					<legend>修改常用工具</legend>
				</fieldset>
				<div class="layui-form-item">
					<label class="layui-form-label">名称：<span style="color: red">*</span></label>
					<div class="layui-input-block">
						<input value="${result.name}" maxlength="45" type="text" name="name" lay-verify="required" autocomplete="off" placeholder="请输入名称" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">地址：<span style="color: red">*</span></label>
					<div class="layui-input-block">
						<input value="${result.link}" maxlength="255" type="text" name="link" lay-verify="url" autocomplete="off" placeholder="请输入地址" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-input-block">
