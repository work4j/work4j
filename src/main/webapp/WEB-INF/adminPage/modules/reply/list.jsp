...
<body>
	<div class="layui-layout layui-layout-admin">
		...
		<jsp:include page="/WEB-INF/adminPage/common/menu_admin.jsp" flush="true">
			<jsp:param value="reply" name="root" />
		</jsp:include>
		<!-- 内容 -->
		<div class="layui-body site-demo">
			<div class="layui-main">
				...
				<div class="layui-elem-quote" style="margin-top: 10px;">
					<span class="layui-breadcrumb"> <a><cite>评论管理</cite></a> <a><cite>列表</cite></a>
					</span>
				</div>
				<blockquote class="layui-elem-quote layui-quote-nm" style="color: #FF5722">
					<i class="layui-icon">&#xe60b;</i> 程序员社区评论列表。
				</blockquote>
				<!--/*******操作*******/-->
						...
						<blockquote class="layui-elem-quote layui-quote-nm">
							...
							<div class="layui-inline" style="float: right;">
								<div class="layui-input-inline" style="width: 200px;">
									<input type="search" id="search" name="search" placeholder="关键字" autocomplete="off" class="layui-input">
								</div>
				...
				<table class="layui-table" lay-even="" lay-skin="row">
					...
					<tbody>
						<c:if test="${result == null || result.size() == 0}">
							<tr>
								<td colspan="3" style="text-align: center;">暂时没有数据</td>
							</tr>
						</c:if>
						<c:if test="${result != null && result.size() != 0}">
