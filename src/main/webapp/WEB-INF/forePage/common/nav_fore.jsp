...
<div class="header">
	<div class="main">
		...
		<div class="nav">
			<a href="${pageContext.request.contextPath}/fore/article/articleList"> <i class="iconfont icon-wenda"></i>社区
			</a> <a href="${pageContext.request.contextPath}/fore/article/articleList"> <i class="iconfont icon-ui"></i>工具
			</a>
		</div>
		<c:if test="${sessionScope.currentUser != null }">
			<div class="nav-user">
				...
				<div class="nav">
					<a href="javacript:void(0);" onclick="layer.msg('功能开发中')"><i class="iconfont icon-shezhi"></i>设置</a> <a href="${pageContext.request.contextPath}/fore/logout"><i class="iconfont icon-tuichu" style="top: 0; font-size: 22px;"></i>退了</a>
				</div>
			</div>
		</c:if>
		<c:if test="${sessionScope.currentUser == null }">
