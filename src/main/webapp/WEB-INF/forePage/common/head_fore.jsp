...
<link id="layuicss-skinlayercss" rel="stylesheet" href="${pageContext.request.contextPath}/resources/others/fly/layui/css/modules/layer/default/layer.css" media="all">
